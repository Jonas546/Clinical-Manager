...
uses
  ...
  Dialogs, Menus, StdCtrls, DBGrids, DbCtrls, DateUtils;

type

  { Tt_podologo_agenda }

  Tt_podologo_agenda = class(TForm)
    Button1: TButton;
...
var
  t_podologo_agenda: Tt_podologo_agenda;
...
{ Tt_podologo_agenda }
uses dm, home, consulta_podologo;
...
procedure Tt_podologo_agenda.FormShow(Sender: TObject);
begin
...
procedure Tt_podologo_agenda.data_buscaChange(Sender: TObject);
begin
...
procedure Tt_podologo_agenda.Button1Click(Sender: TObject);
begin

  if db_txt_guia.Text <> '' then
     begin
          t_consulta_podologo.ShowModal;
     end
  else
      begin
...
procedure Tt_podologo_agenda.FormClose(Sender: TObject;
