...
type
  ...
  { Tt_cardiologista_proc }

  Tt_cardiologista_proc = class(TForm)
    Button1: TButton;
    Label1: TLabel;
    Label2: TLabel;
    MainMenu1: TMainMenu;
...
var
  t_cardiologista_proc: Tt_cardiologista_proc;
  esp: String;
...
procedure Tt_cardiologista_proc.FormCreate(Sender: TObject);
begin
...
procedure Tt_cardiologista_proc.MenuItem1Click(Sender: TObject);
begin
  t_cardiologista_gerenciar_proc.ShowModal;
end;

procedure Tt_cardiologista_proc.FormClose(Sender: TObject;
...
procedure Tt_cardiologista_proc.Button1Click(Sender: TObject);
begin
