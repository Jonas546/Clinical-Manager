...
type
  ...
  { Tt_dentista_materiais }

  Tt_dentista_materiais = class(TForm)
    DBEdit1: TDBEdit;
    DBEdit2: TDBEdit;
    DBGrid1: TDBGrid;
...
var
  t_dentista_materiais: Tt_dentista_materiais;
  a_guia: integer;

implementation

{$R *.lfm}
uses dm, consulta_dentista;

{ Tt_dentista_materiais }

procedure Tt_dentista_materiais.FormShow(Sender: TObject);
begin
...
procedure Tt_dentista_materiais.FormClose(Sender: TObject;
