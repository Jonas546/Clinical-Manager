...
type
  ...
  { Tt_oftalmo_orcamento }

  Tt_oftalmo_orcamento = class(TForm)
    Button1: TButton;
    Button2: TButton;
    Button3: TButton;
    DBGrid1: TDBGrid;
...
var
  t_oftalmo_orcamento: Tt_oftalmo_orcamento;
  a_guia: integer;
...
{$R *.lfm}
uses dm, consulta_oftalmo, oftalmo_orcamento_pdf;
...
procedure Tt_oftalmo_orcamento.FormShow(Sender: TObject);
begin
  ...
  DMC.query_itens.Active:=true;
    ...
    db_txt_guia.Text:=t_consulta_oftalmo.db_txt_guia.Text;
    db_txt_nome.Text:=t_consulta_oftalmo.db_txt_nome.Text;
    db_txt_id_paciente.Text:=t_consulta_oftalmo.db_txt_id_paciente.Text;

    a_guia:=strtoint(t_consulta_oftalmo.db_txt_guia.Text);
    ...
    txt_medico.Text:=t_consulta_oftalmo.Label9.Caption;

end;

procedure Tt_oftalmo_orcamento.FormClose(Sender: TObject;
...
procedure Tt_oftalmo_orcamento.Button2Click(Sender: TObject);
var
  x_id: integer;
begin
...
procedure Tt_oftalmo_orcamento.Button1Click(Sender: TObject);
begin
  t_oftalmo_orcamento_pdf.RLOrcamento.Preview();
end;

procedure Tt_oftalmo_orcamento.Button3Click(Sender: TObject);
var
  x_guia: integer;
  t_total: Double;
begin
