...
uses
  ...
  Dialogs, StdCtrls, DBGrids, DbCtrls, DateUtils;

type

  { Tt_dentista_atendimento }

  Tt_dentista_atendimento = class(TForm)
    Button1: TButton;
...
var
  t_dentista_atendimento: Tt_dentista_atendimento;
...
{ Tt_dentista_atendimento }
uses dm, home,consulta_dentista;
...
procedure Tt_dentista_atendimento.FormShow(Sender: TObject);
begin
...
procedure Tt_dentista_atendimento.FormClose(Sender: TObject;
...
procedure Tt_dentista_atendimento.FormCreate(Sender: TObject);
begin
...
procedure Tt_dentista_atendimento.Button1Click(Sender: TObject);
begin

  if db_txt_guia.Text <> '' then
     begin
        t_consulta_dentista.ShowModal;
     end
  else
      begin
...
procedure Tt_dentista_atendimento.data_buscaChange(Sender: TObject);
begin
