unit infectologista_orcamento_pdf;
...
type
  ...
  { Tt_infectologista_orcamento_pdf }

  Tt_infectologista_orcamento_pdf = class(TForm)
    lb_data: TRLLabel;
    lb_guia: TRLLabel;
    lb_hora: TRLLabel;
    lb_mat: TRLLabel;
...
var
  t_infectologista_orcamento_pdf: Tt_infectologista_orcamento_pdf;

implementation

{$R *.lfm}
uses dm, infectologista_orcamento, consulta_infectologista;

{ Tt_infectologista_orcamento_pdf }

procedure Tt_infectologista_orcamento_pdf.RLOrcamentoBeforePrint(
  Sender: TObject; var PrintIt: boolean);
begin

  with t_consulta_infectologista do
       begin
  ...
  with t_infectologista_orcamento do
       begin
