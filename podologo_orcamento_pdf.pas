...
type
  ...
  { Tt_podologo_orcamento_pdf }

  Tt_podologo_orcamento_pdf = class(TForm)
    RLBand1: TRLBand;
    RLBand2: TRLBand;
    RLBand3: TRLBand;
    RLBand4: TRLBand;
...
var
  t_podologo_orcamento_pdf: Tt_podologo_orcamento_pdf;
...
{ Tt_podologo_orcamento_pdf }
uses dm, podologo_orcamento, consulta_podologo;

procedure Tt_podologo_orcamento_pdf.RLOrcamentoBeforePrint(Sender: TObject;
  var PrintIt: boolean);
begin

  with t_consulta_podologo do
       begin
