...
type
  ...
  { Tt_relatorio_convenio_pdf }

  Tt_relatorio_convenio_pdf = class(TForm)
    lb_conv: TRLLabel;
    lb_emp: TRLLabel;
    lb_medico: TRLLabel;
    lb_plano: TRLLabel;
...
var
  t_relatorio_convenio_pdf: Tt_relatorio_convenio_pdf;
  a_guia:integer;
  t_guia,pref:String;
...
procedure Tt_relatorio_convenio_pdf.RLConveniosBeforePrint(Sender: TObject;
  var PrintIt: boolean);
begin
   ...
   with t_lancamento_convenio do
     ...
     //DMOS.query_convenios.SQL.Add('group by lc.status');
...
procedure Tt_relatorio_convenio_pdf.RLConveniosPageEnding(Sender: TObject);
begin
...
procedure Tt_relatorio_convenio_pdf.RLDBText17AfterPrint(Sender: TObject);
begin

end;

procedure Tt_relatorio_convenio_pdf.FormClose(Sender: TObject;
