...
type
  ...
  { Tt_po_gerenciar_procedimentos }

  Tt_po_gerenciar_procedimentos = class(TForm)
    DBEdit1: TDBEdit;
    DBGrid1: TDBGrid;
...
var
  t_po_gerenciar_procedimentos: Tt_po_gerenciar_procedimentos;
  esp:String;
...
procedure Tt_po_gerenciar_procedimentos.FormShow(Sender: TObject);
begin
...
procedure Tt_po_gerenciar_procedimentos.FormClose(Sender: TObject;
