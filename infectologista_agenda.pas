...
type
  ...
  { Tt_infectologista_agenda }

  Tt_infectologista_agenda = class(TForm)
    Button1: TButton;
...
var
  t_infectologista_agenda: Tt_infectologista_agenda;
...
{$R *.lfm}
uses dm, home, consulta_infectologista;
...
procedure Tt_infectologista_agenda.FormShow(Sender: TObject);
begin
...
procedure Tt_infectologista_agenda.data_buscaChange(Sender: TObject);
begin
...
procedure Tt_infectologista_agenda.FormClose(Sender: TObject;
...
procedure Tt_infectologista_agenda.Button1Click(Sender: TObject);
begin

  if db_txt_guia.Text <> '' then
     begin
          t_consulta_infectologista.ShowModal;
     end
  else
      begin
