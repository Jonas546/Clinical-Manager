...
type
  ...
  { Tt_oftalmo_gerenciar_proc }

  Tt_oftalmo_gerenciar_proc = class(TForm)
    DBEdit1: TDBEdit;
    DBGrid1: TDBGrid;
...
var
  t_oftalmo_gerenciar_proc: Tt_oftalmo_gerenciar_proc;
  esp:String;
...
procedure Tt_oftalmo_gerenciar_proc.FormShow(Sender: TObject);
begin
...
procedure Tt_oftalmo_gerenciar_proc.FormClose(Sender: TObject;
