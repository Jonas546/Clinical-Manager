...
type
  ...
  { Tt_relatorio_convenio_pdf4 }

  Tt_relatorio_convenio_pdf4 = class(TForm)
...
var
  t_relatorio_convenio_pdf4: Tt_relatorio_convenio_pdf4;
  a_guia:integer;
  t_guia,pref:String;
...
procedure Tt_relatorio_convenio_pdf4.RLConveniosBeforePrint(Sender: TObject;
  var PrintIt: boolean);
begin
...
procedure Tt_relatorio_convenio_pdf4.RLConveniosPageEnding(Sender: TObject);
begin
