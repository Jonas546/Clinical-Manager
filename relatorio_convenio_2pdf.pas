...
type
  ...
  { Tt_relatorio_entrega2 }

  Tt_relatorio_entrega2 = class(TForm)
...
var
  t_relatorio_entrega2: Tt_relatorio_entrega2;
  a_guia:integer;
  t_guia,pref:String;
...
procedure Tt_relatorio_entrega2.RLConveniosBeforePrint(Sender: TObject;
  var PrintIt: boolean);
begin
...
procedure Tt_relatorio_entrega2.RLConveniosPageEnding(Sender: TObject);
begin
