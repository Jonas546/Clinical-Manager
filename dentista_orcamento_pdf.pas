...
type
  ...
  { Tt_dentista_orcamento_pdf }

  Tt_dentista_orcamento_pdf = class(TForm)
    lb_data: TRLLabel;
    lb_guia: TRLLabel;
    lb_hora: TRLLabel;
    lb_mat: TRLLabel;
...
var
  t_dentista_orcamento_pdf: Tt_dentista_orcamento_pdf;

implementation

{$R *.lfm}
uses dm, orcamento, consulta_dentista;

{ Tt_dentista_orcamento_pdf }

procedure Tt_dentista_orcamento_pdf.RLOrcamentoBeforePrint(Sender: TObject;
  var PrintIt: boolean);
begin

  with t_consulta_dentista do
       begin
