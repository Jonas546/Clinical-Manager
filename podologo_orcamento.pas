...
type
  ...
  { Tt_podologo_orcamento }

  Tt_podologo_orcamento = class(TForm)
    Button1: TButton;
    Button2: TButton;
    Button3: TButton;
    DBGrid1: TDBGrid;
...
var
  t_podologo_orcamento: Tt_podologo_orcamento;
  a_guia: integer;
...
{ Tt_podologo_orcamento }
uses dm, consulta_podologo, podologo_orcamento_pdf;
...
procedure Tt_podologo_orcamento.FormShow(Sender: TObject);
begin
  ...
  db_txt_guia.Text:=t_consulta_podologo.db_txt_guia.Text;
  db_txt_nome.Text:=t_consulta_podologo.db_txt_nome.Text;
  db_txt_id_paciente.Text:=t_consulta_podologo.db_txt_id_paciente.Text;
  ...
  txt_medico.Text:=t_consulta_podologo.Label9.Caption;

end;

procedure Tt_podologo_orcamento.FormClose(Sender: TObject;
...
procedure Tt_podologo_orcamento.Button2Click(Sender: TObject);
var
  x_id: integer;
begin
...
procedure Tt_podologo_orcamento.Button1Click(Sender: TObject);
begin
  t_podologo_orcamento_pdf.RLOrcamento.Preview();
end;

procedure Tt_podologo_orcamento.Button3Click(Sender: TObject);
var
  x_guia: integer;
  t_total: Double;
begin
