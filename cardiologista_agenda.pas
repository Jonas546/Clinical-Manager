...
type
  ...
  { Tt_cardiologista_agenda }

  Tt_cardiologista_agenda = class(TForm)
    Button1: TButton;
...
var
  t_cardiologista_agenda: Tt_cardiologista_agenda;
...
{$R *.lfm}
uses dm, home, consulta_cardiologista;
...
procedure Tt_cardiologista_agenda.FormShow(Sender: TObject);
begin
...
procedure Tt_cardiologista_agenda.data_buscaChange(Sender: TObject);
begin
...
procedure Tt_cardiologista_agenda.FormClose(Sender: TObject;
...
procedure Tt_cardiologista_agenda.Button1Click(Sender: TObject);
begin
...
procedure Tt_cardiologista_agenda.Button2Click(Sender: TObject);
begin
