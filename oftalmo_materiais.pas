...
type
  ...
  { Tt_oftalmo_materiais }

  Tt_oftalmo_materiais = class(TForm)
    DBEdit1: TDBEdit;
    DBEdit2: TDBEdit;
    DBGrid1: TDBGrid;
...
var
  t_oftalmo_materiais: Tt_oftalmo_materiais;
  a_guia: integer;

implementation

{$R *.lfm}
uses dm, consulta_oftalmo;

{ Tt_oftalmo_materiais }

procedure Tt_oftalmo_materiais.FormShow(Sender: TObject);
begin
...
procedure Tt_oftalmo_materiais.FormClose(Sender: TObject;
