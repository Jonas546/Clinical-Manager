...
type
  ...
  { Tt_cardiologista_orcamento }

  Tt_cardiologista_orcamento = class(TForm)
    Button1: TButton;
    Button2: TButton;
    Button3: TButton;
    DBGrid1: TDBGrid;
    ...
    procedure txt_v_consultaChange(Sender: TObject);
  private
...
var
  t_cardiologista_orcamento: Tt_cardiologista_orcamento;
  a_guia: integer;
...
{$R *.lfm}
uses dm, consulta_cardiologista, cardiologista_orcamento_pdf;
...
procedure Tt_cardiologista_orcamento.FormClose(Sender: TObject;
...
procedure Tt_cardiologista_orcamento.Button3Click(Sender: TObject);
var
  x_guia: integer;
  t_total: Double;
begin
...
procedure Tt_cardiologista_orcamento.Button2Click(Sender: TObject);
var
x_id: integer;
begin
...
procedure Tt_cardiologista_orcamento.Button1Click(Sender: TObject);
begin
  t_cardiologista_orcamento_pdf.RLOrcamento.Preview();
end;

procedure Tt_cardiologista_orcamento.FormShow(Sender: TObject);
begin
    ...
    db_txt_guia.Text:=t_consulta_cardiologista.db_txt_guia.Text;
    db_txt_nome.Text:=t_consulta_cardiologista.db_txt_nome.Text;
    db_txt_id_paciente.Text:=t_consulta_cardiologista.db_txt_id_paciente.Text;
    ...
    txt_medico.Text:=t_consulta_cardiologista.Label9.Caption;

end;

procedure Tt_cardiologista_orcamento.txt_v_consultaChange(Sender: TObject);
begin
