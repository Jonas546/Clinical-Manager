unit cardiologista_procedimentos;
...
type
  ...
  { Tt_cardiolgista_procedimentos }

  Tt_cardiolgista_procedimentos = class(TForm)
    Button1: TButton;
    Label1: TLabel;
    Label2: TLabel;
    MainMenu1: TMainMenu;
...
var
  t_cardiolgista_procedimentos: Tt_cardiolgista_procedimentos;
  esp: String;

implementation

{$R *.lfm}
uses dm, home, cardiologista_gerenciar_proc;

{ Tt_cardiolgista_procedimentos }

procedure Tt_cardiolgista_procedimentos.FormCreate(Sender: TObject);
begin
  DMC.qr_list_proc.Active:=true;
end;

procedure Tt_cardiolgista_procedimentos.MenuItem1Click(Sender: TObject);
begin
  t_cardiologista_gerenciar_proc.ShowModal;
end;

procedure Tt_cardiolgista_procedimentos.FormClose(Sender: TObject;
  var CloseAction: TCloseAction);
begin
  DMC.qr_list_proc.Active:=false;
end;

procedure Tt_cardiolgista_procedimentos.Button1Click(Sender: TObject);
begin
