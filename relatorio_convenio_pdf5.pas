...
type
  ...
  { Tt_relatorio_convenio_pdf5 }

  Tt_relatorio_convenio_pdf5 = class(TForm)
...
var
  t_relatorio_convenio_pdf5: Tt_relatorio_convenio_pdf5;
  a_guia:integer;
  t_guia,pref:String;
...
procedure Tt_relatorio_convenio_pdf5.RLConveniosBeforePrint(Sender: TObject;
  var PrintIt: boolean);
begin
...
procedure Tt_relatorio_convenio_pdf5.RLConveniosPageEnding(Sender: TObject);
begin
