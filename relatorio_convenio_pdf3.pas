...
type
  ...
  { Tt_relatorio_convenio_pdf3 }

  Tt_relatorio_convenio_pdf3 = class(TForm)
...
var
  t_relatorio_convenio_pdf3: Tt_relatorio_convenio_pdf3;
  a_guia:integer;
  t_guia,pref:String;
...
procedure Tt_relatorio_convenio_pdf3.RLConveniosBeforePrint(Sender: TObject;
  var PrintIt: boolean);
begin
...
procedure Tt_relatorio_convenio_pdf3.RLConveniosPageEnding(Sender: TObject);
begin
